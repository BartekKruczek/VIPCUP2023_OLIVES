...
def combine_excel(csv_dir):
    ...
    for file in filenames:
        df = pd.concat(
            pd.read_excel(file, sheet_name=None), ignore_index=True, sort=False
        )
...
if __name__ == "__main__":
    csv_dir = "C:/Users/krucz/Documents/GitHub/vipcup2023/GitHub-testing/VIPCUP2023_OLIVES/csv_dir/test_set_submission_template.csv"
    np_dir = "C:/Users/krucz/Documents/GitHub/vipcup2023/GitHub-testing/VIPCUP2023_OLIVES/output.npy"
