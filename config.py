...
def parse_option():
    ...
    parser.add_argument(
        "--dataset", type=str, default="TREX_DME", choices=["OLIVES"], help="dataset"
    )
    parser.add_argument(
    ...
    opt.model_name = "{}_lr_{}_decay_{}_bsz_{}_temp_{}".format(
        opt.model, opt.learning_rate, opt.weight_decay, opt.batch_size, opt.temp
    )
